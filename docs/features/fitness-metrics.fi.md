...
openkoutsi seuraa kolmea toisiinsa liittyvää lukua, jotka yhdessä kuvaavat
harjoituskuormitustasi ajan myötä. Ne näytetään interaktiivisina kaavioina
kojelaudallasi.
...
- **20 minuutin** menetelmä (95 % parhaasta 20 minuutin tehostasi), tai
- **Critical Power** -menetelmä.

Arvio näytetään Teho-näkymässä, ja voit hyväksyä kumman tahansa asettaaksesi sen
profiilisi FTP:ksi.
