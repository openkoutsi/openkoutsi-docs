...
| This was an interval session | The measurement would describe the intervals, not your durability. Judged on variability index *and* how hard the ride was overall, so a long ride made variable by descents, junctions and stops still gets its figure. |
